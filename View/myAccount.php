                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-element">
                                                                ...
                                                                <label for="file-5" id="file-5-preview">
                                                                    <img src="<?php echo $user['user_img']?>" class="img-responsive" >
                                                                    <div>
                                                                        <span>+</span>
                                                                    </div>
                                                                    <button type="submit" class="btn btn-outline-dark" name="UPDATEPROFILE" style="margin-top: 10px;margin-left: 75px;">Save Changes</button>   
                                                                </label>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="contact" value="<?php echo $user['contact_number']?>"> 
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Address</label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    ...
                                                                    <a href="#signin-modal" data-toggle="modal" class="btn btn-dark" style="width: 203px;">Change Password</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                                <input type="text" class="form-control" name="email" id="emailInput" value="<?php echo $users['email']?>">
                                                            </div>
                                                            <button type="submit" class="btn btn-outline-dark" name="UPDATEUSER">Save Changes</button>   
                                                        </div> 
                                                    </div>
                                                </form>
                                            </div>
