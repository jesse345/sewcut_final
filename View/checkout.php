...
<body>
                                        ...
                                        <tbody>
                                            ...
                                            while($c = mysqli_fetch_assoc($cart)):
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="price-col"><?=$productPrice['price']?></td>
                                                    <td class="price-quantity"><?=$c['quantity']?></td>
                                                    <td><?=$c['total']?></td>
                                                </tr>
                        <form action="../Controller/orderController.php" method="POST">
                                                <input type="hidden" name="seller_id" value="<?=$_GET['seller']?>">
                                                 <input type="hidden" name="subTotal" value="<?=$_GET['subTotal']?>">
	                				...
	                				<table class="table table-summary">
	                					<tbody>
	                						<tr class="summary-shipping-estimate">
	                							<td>Shipping Info<br> <a href="#ShippingInfo-Modal" data-toggle="modal">Change Shipping Info</a></td>
                                                <input type="hidden" class="form-control" name="fullname" value="<?=ucfirst($shipping_info['name'])?>">
                                                <input type="hidden" class="form-control" name="contact_number" value="<?=$shipping_info['contact']?>">
                                                <input type="hidden" class="form-control" name="address" value="<?=$shipping_info['address']?>">
	                							<td>&nbsp;</td>
	                						</tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="radio" name="payment-type" value="onlinepayment" required></td>
                                            </tr>
	                						...
	                						<tr class="summary-total" style="border-top:none">
	                							<td>Total:</td>
	                							<td>P <?=$_GET['subTotal']?></td>
	                						</tr>
	                					</tbody>
	                				</table>
	                				<button type="submit" class="btn btn-outline-primary-2 btn-order btn-block" name="PLACEORDER">PLACE ORDER</button>
                                </form>
	                			</div><!-- End .summary -->
	                		</aside><!-- End .col-lg-3 -->
	                	</div><!-- End .row -->
    ...
    <div class="modal fade" id="ShippingInfo-Modal" tabindex="-1" role="dialog" aria-hidden="true" style="margin-top:200px;">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>FullName</label>
                                 <input type="hidden" class="form-control" name="shipping_id" value="<?=ucfirst($shipping_info['id'])?>">
                                <input type="text" class="form-control" name="fullname" value="<?=ucfirst($shipping_info['name'])?>">
                            </div>
                            <div class="form-group">
                                <label>Contact Number</label>
                                <input type="text" class="form-control" name="contact_number" value="<?=$shipping_info['contact']?>">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" class="form-control" name="address" value="<?=$shipping_info['address']?>">
                            </div>
                        </div> 
                    </div>
                    <div class="modal-footer">
