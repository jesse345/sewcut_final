                                ...
                                <ul class="list-unstyled mb-0 overflow-auto" id="chatList">
                                    <?php if (!empty($conversations)) { ?>
                                        ...
                                        <li class="list-group-item">
                                            <a href="chat.php?user=<?php echo $conversation['id']?>" class="d-flex justify-content-between align-items-center p-2">
                            ...
                            <div class="card-header" style="border-top: 4px solid #0d6efd;">
                                <div class="d-flex">
                                    ...
                                    if(!empty($_GET['user'])){
                                        ...
                                        <h3 class="display-4 fs-sm m-2" style="font-size:18px;color: #000;font-weight: 700;">
                                            <?php echo ucfirst($chatWith['firstname']). '  ' . ucfirst($chatWith['lastname']) ?> <br>
                                            <div class="d-flex
                                                        align-items-center"
                                                    title="online">
                                                <?php
                                    ...
                                    foreach($chats as $chat){  
                                        ...
                                        <?php }else{ ?>
                                            ...
                                            <div class="d-flex justify-content-start">
                                                <p class="small mb-1"><?php echo ucfirst($chatWith['firstname']).' '.ucfirst($chatWith['lastname'])?></p>
                                            </div>
                            ...
                            if(isset($_SESSION['id'])){  
                                ...
                                <div class="card-footer text-muted d-flex justify-content-start align-items-center p-3">
                                        <div class="input-group mb-0">
                                            ...
                                            <input type="text" class="form-control" id="message" placeholder="Type message" style="width:569px;"/>
